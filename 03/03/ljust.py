s = b'abc'; print(b'>' + s.ljust(8) + b'<')
s = b'abc'; print(b'>' + s.ljust(8, b'-') + b'<')
...
s = bytearray(b'abc'); print(bytearray(b'>') + s.ljust(8) + bytearray(b'<'))
s = bytearray(b'abc'); print(bytearray(b'>') + s.ljust(8, bytearray(b'-')) + bytearray(b'<'))
