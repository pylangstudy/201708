...
print(stringprep.in_table_c12(' '))
print(stringprep.in_table_c12('　'))
print(stringprep.in_table_c12('\t'))
print(stringprep.in_table_c12('-'))
print(stringprep.in_table_c12('a'))
print(stringprep.in_table_c12('あ'))
"""
for code in range(0x2FFFF+1):
    ...
    print('{:5x} {} {}'.format(code, chr(code), stringprep.in_table_c12(chr(code))))
